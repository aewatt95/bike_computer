...
CPP_SRCS += \
../Core/Src/displayFunctions.cpp \
../Core/Src/main.cpp 

OBJS += \
./Core/Src/displayFunctions.o \
./Core/Src/main.o \
...
CPP_DEPS += \
./Core/Src/displayFunctions.d \
./Core/Src/main.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/displayFunctions.o: ../Core/Src/displayFunctions.cpp
	arm-none-eabi-g++ "$<" -mcpu=cortex-m3 -std=gnu++14 -g3 -DUSE_HAL_DRIVER -DSTM32F103xB -DDEBUG -c -I../Drivers/CMSIS/Device/ST/STM32F1xx/Include -I../Drivers/CMSIS/Include -I../Core/Inc -I../Drivers/STM32F1xx_HAL_Driver/Inc/Legacy -I../Drivers/STM32F1xx_HAL_Driver/Inc -O0 -ffunction-sections -fdata-sections -fno-exceptions -fno-rtti -fno-threadsafe-statics -fno-use-cxa-atexit -Wall -fstack-usage -MMD -MP -MF"Core/Src/displayFunctions.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
